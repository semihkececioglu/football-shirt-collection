...
const Contact = () => {
  ...
  return (
    <>
      <SEO
        title="Contact"
        description="Get in touch with Football Shirt Collection. We'd love to hear from you."
      />
      ...
      <main className="pt-32 pb-16 sm:pb-24">
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-3xl sm:text-4xl font-display font-light text-stone-900 dark:text-stone-50 mb-4 tracking-tight">
          ...
          <motion.form
            ...
            className="space-y-6 bg-white dark:bg-stone-800/50 rounded-2xl border border-stone-200 dark:border-stone-700 p-6 sm:p-8"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
